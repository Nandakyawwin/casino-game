...
function buildBettingBoard() {
	...
	bankSpan.innerText = 'Bet = ' + bankValue.toLocaleString("en-GB") + '';
	...
	betSpan.innerText = 'Amount = ' + currentBet.toLocaleString("en-GB") + '';
	bet.append(betSpan);
...
function setBet(e, n, t, o) {
	...
	if (wager > 0) {
		...
		document.getElementById('bankSpan').innerText = 'Bet ' + bankValue.toLocaleString("en-GB") + '';
		document.getElementById('betSpan').innerText = '' + currentBet.toLocaleString("en-GB") + '';
